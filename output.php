...
try{
// code here!
$sql = 'SELECT id, nama,sensor_kelembaban,sensor_n,sensor_p,sensor_k,sensor_ph, readTime FROM server_data';
...
<a target="_blank" href="export.php"> <button type="button" class="btn btn-primary"> Export Data</button></a>
